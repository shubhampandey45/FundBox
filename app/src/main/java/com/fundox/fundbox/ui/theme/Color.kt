...
internal val secondaryLight = Color(0xFFFFFFFF)
internal val onSecondaryLight = Color(0xFF1A243B)
...
internal val onPrimaryContainerLight = Color(0xFF212529)
internal val secondaryContainerLight = Color(0xFF212529)
...
//Dark theme colors
internal val primaryDark = Color(0xFF0077b6)
internal val onPrimaryDark = Color(0xFFFFFFFF)
internal val secondaryDark = Color(0xFFfdfcdc)
internal val onSecondaryDark = Color(0xFF1A243B)
...
internal val onTertiaryContainerDark = Color(0xFF3d5a80)
internal val backgroundDark = Color(0xFF1A243B)